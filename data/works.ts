...
export const works: Work[] = [
  ...
  },
  {
    ...
    credits: [
      ...
      { role: "Assistant Director", name: "sm.lee" },
      { role: "DOP", name: "Choi Youngwoo" },
      { role: "Camera crew", name: "Yoo Hyunjin, Kim Hyunsoo, Ko Yuntae, Woo taemin" },
      { role: "Gaffer", name: "Park Sunghun" },
      { role: "Lighting crew", name: "Yoon Changhwan, Lee Hyunwoo, Yoon Dowoon, Kwon Youngjun, Kwon Sungbum" },
      { role: "Art Director", name: "Kim Dooeun" },
      { role: "Art Team", name: "Shim Hyunjun, Kim boyoon" },
      { role: "FD", name: "Kim Daegun, Ryu Hanjong, Lee Junyoung" },
      { role: "Edit", name: "Yang Siwook (@yangsiwook)" },
      { role: "DI", name: "CDL (@cdl_nolut)" },
      { role: "Beauty", name: "DIAP (@digital_apgujeong)" },
      { role: "Clean", name: "SEWOO, Chen Yizhi" },
      { role: "Comp", name: "SEWOO" },
    ],
    stills: [],
  },
  {
